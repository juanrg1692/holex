...
//templates
  ...
  //ellipse(20,20,15,15);
   ...
   if(state00 === true){
      ...
      fill(255);
      ellipse(47,250,5,5);
      ellipse(87,250,10,10);
      ellipse(137,250,15,15);
      ellipse(197,250,18,18);
  ...
  if(keyIsPressed){
    if(key === '1'){
      ...
      textAlign(LEFT);
      fill(0);
      text("Vista 1 guardada",25,height/2-25);
      ...
      textAlign(LEFT);
      fill(0);
      text("Vista 2 guardada",25,height/2-25);
...
function mousePressed() {
  ...
  if (dist(mouseX, mouseY, 47,250) < 5) {
    penSize = 1;
  }

    if (dist(mouseX, mouseY, 87,250) < 5) {
    penSize = 5;
  }

      if (dist(mouseX, mouseY, 137,250) < 10) {
    penSize = 10;
  }

       if (dist(mouseX, mouseY, 197,250) < 15) {
    penSize = 15;
  }
